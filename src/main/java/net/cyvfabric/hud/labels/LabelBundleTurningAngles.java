    ...
    public LabelBundleTurningAngles() {
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, ja+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Jump Angle: ")
            ...
            public void renderDummy(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, "Jump Angle: ", pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1 + getHeight()*0, color1);
                drawString(context, str+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Jump Angle: ")
                        , pos.getAbsoluteY() + 1, color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, st, pos.getAbsoluteX() + 1 + font.width("Second Turn: ")
            ...
            public void renderDummy(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, "Second Turn: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                drawString(context, str, pos.getAbsoluteX() + 1 + font.width("Second Turn: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, pt+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Preturn: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
            public void renderDummy(GuiGraphics context, ScreenPosition pos) {
                int d = CyvClientConfig.getInt("df",5);
                ...
                drawString(context, "Preturn: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                drawString(context, str+"\u00B0", pos.getAbsoluteX() + 1 + font.width("Preturn: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
    }
