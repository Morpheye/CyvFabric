    ...
    public LabelBundleLandingCoords() {
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, x, pos.getAbsoluteX() + 1 + font.width("Last Landing X: ")
            ...
            public void renderDummy(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, "Last Landing X: ", pos.getAbsoluteX() + 1, pos.getAbsoluteY() + 1, color1);
                drawString(context, str, pos.getAbsoluteX() + 1 + font.width("Last Landing X: ")
                        , pos.getAbsoluteY() + 1, color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, y, pos.getAbsoluteX() + 1 + font.width("Last Landing Y: ")
            ...
            public void renderDummy(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, "Last Landing Y: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                drawString(context, str, pos.getAbsoluteX() + 1 + font.width("Last Landing Y: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(GuiGraphics context, ScreenPosition pos) {
                ...
                drawString(context, z, pos.getAbsoluteX() + 1 + font.width("Last Landing Z: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
            public void renderDummy(GuiGraphics context, ScreenPosition pos) {
                int d = CyvClientConfig.getInt("df",5);
                ...
                drawString(context, "Last Landing Z: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                drawString(context, str, pos.getAbsoluteX() + 1 + font.width("Last Landing Z: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
    }
