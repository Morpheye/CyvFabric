    ...
    public LabelBundleTickTimings() {
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(DrawContext context, ScreenPosition pos) {
                ...
                drawString(context, stopTime, pos.getAbsoluteX() + 1 + font.getWidth("Stoptime: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
            public void renderDummy(DrawContext context, ScreenPosition pos) {
                long color1 = CyvClientColorHelper.color1.drawColor;
                ...
                drawString(context, "Stoptime: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                drawString(context, 0, pos.getAbsoluteX() + 1 + font.getWidth("Stoptime: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
        ...
        this.labels.add(new DraggableHUDElement() {
            ...
            public void render(DrawContext context, ScreenPosition pos) {
                ...
                drawString(context, runtime, pos.getAbsoluteX() + 1 + font.getWidth("Runtime: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
            public void renderDummy(DrawContext context, ScreenPosition pos) {
                long color1 = CyvClientColorHelper.color1.drawColor;
                ...
                drawString(context, "Runtime: ", pos.getAbsoluteX() + 1, (int) (pos.getAbsoluteY() + 1), color1);
                drawString(context, 0, pos.getAbsoluteX() + 1 + font.getWidth("Runtime: ")
                        , (int) (pos.getAbsoluteY() + 1), color2);
            }
        });
    }
