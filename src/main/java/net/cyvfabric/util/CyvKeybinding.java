...
public class CyvKeybinding extends KeyMapping {
    ...
    public static final KeyMapping.Category KEY_CATEGORY_CYVFABRIC = KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath(CyvFabric.MOD_ID, "cyv_keys")); //cyvfabric keybinding category
